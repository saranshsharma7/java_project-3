...
Partial Public Class loginDataSet
    ...
    Partial Public Class loginDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddloginRow(ByVal Username As String, ByVal Password As String, ByVal End_Time As Date, ByVal Location As String, ByVal Description As String, ByVal Attachments As String) As loginRow
            Dim rowloginRow As loginRow = CType(Me.NewRow,loginRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Username, Password, End_Time, Location, Description, Attachments}
    ...
    Partial Public Class loginRow
        ...
        Public Property End_Time() As Date
            Get
                Try 
                    Return CType(Me(Me.tablelogin.End_TimeColumn),Date)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'End Time' in table 'login' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablelogin.End_TimeColumn) = value
            End Set
        End Property
        ...
        Public Property Attachments() As String
            Get
                Try 
                    Return CType(Me(Me.tablelogin.AttachmentsColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Attachments' in table 'login' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablelogin.AttachmentsColumn) = value
            End Set
        End Property
        ...
        Public Function IsEnd_TimeNull() As Boolean
            Return Me.IsNull(Me.tablelogin.End_TimeColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Sub SetEnd_TimeNull()
            Me(Me.tablelogin.End_TimeColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Function IsLocationNull() As Boolean
            Return Me.IsNull(Me.tablelogin.LocationColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Sub SetLocationNull()
            Me(Me.tablelogin.LocationColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Function IsDescriptionNull() As Boolean
            Return Me.IsNull(Me.tablelogin.DescriptionColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Sub SetDescriptionNull()
            Me(Me.tablelogin.DescriptionColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Function IsAttachmentsNull() As Boolean
            Return Me.IsNull(Me.tablelogin.AttachmentsColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Sub SetAttachmentsNull()
            Me(Me.tablelogin.AttachmentsColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class loginTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `login` WHERE ((`ID` = ?) AND ((? = 1 AND `Username` IS NULL) OR (`Us"& _ 
                ...
                " 1 AND `End Time` IS NULL) OR (`End Time` = ?)) AND ((? = 1 AND `Location` IS NU"& _ 
                "LL) OR (`Location` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `login` (`Username`, `Password`, `End Time`, `Location`, `Description"& _ 
                "`, `Attachments`) VALUES (?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `login` SET `Username` = ?, `Password` = ?, `End Time` = ?, `Location` = ?"& _ 
                ", `Description` = ?, `Attachments` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Userna"& _ 
                "me` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Passw"& _ 
                "ord` = ?)) AND ((? = 1 AND `End Time` IS NULL) OR (`End Time` = ?)) AND ((? = 1 "& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.vb_pharmacy_management_system.My.MySettings.Default.loginConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Username, [Password], [End Time], Location, Description, Attachments F"& _ 
                "ROM login"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        COUNT(*) AS Expr1, Username, [Password]"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            login"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"GRO"& _ 
                "UP BY Username, [Password]"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"HAVING        (COUNT(*) = 1) AND (Username = ?) AND "& _ 
                "([Password] = ?)"
            ...
            Me._commandCollection(2).CommandText = "SELECT        COUNT(*) AS Expr1, Username, [Password]"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            login"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"GRO"& _ 
                "UP BY Username, [Password]"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"HAVING        (COUNT(*) = 1) AND (Username = ?) AND "& _ 
                "([Password] = ?)"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Username As String, ByVal Original_Password As String, ByVal Original_End_Time As Global.System.Nullable(Of Date), ByVal Original_Location As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Username As String, ByVal Password As String, ByVal End_Time As Global.System.Nullable(Of Date), ByVal Location As String, ByVal Description As String, ByVal Attachments As String) As Integer
            ...
            If (End_Time.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(2).Value = CType(End_Time.Value,Date)
            Else
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(5).Value = CType(Attachments,String)
            End If
        ...
        Public Overloads Overridable Function Update(ByVal Username As String, ByVal Password As String, ByVal End_Time As Global.System.Nullable(Of Date), ByVal Location As String, ByVal Description As String, ByVal Attachments As String, ByVal Original_ID As Integer, ByVal Original_Username As String, ByVal Original_Password As String, ByVal Original_End_Time As Global.System.Nullable(Of Date), ByVal Original_Location As String) As Integer
            If (Username Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Username")
            Else
            ...
            End If
            If (End_Time.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(2).Value = CType(End_Time.Value,Date)
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Attachments,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function login_invalid(ByVal Username As String, ByVal Password As String) As Global.System.Nullable(Of Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function UserDetails(ByVal Username As String, ByVal Password As String) As Global.System.Nullable(Of Integer)
